  ...
  return (
      <div className='container'>
        ...
        <p className="bottom-space-md" />
            ...
            <p style={{textAlign:'center', fontSize:'14px'}}>Connect with us</p>
        </div>
                    <div className='row'>
                    <div className='col'>
                        <div className='btn'>
        ...
        <div className='team__container'>
                <div to='' className='team__container-card'>
                    <div className='team__container-cardInfo'>
                      ...
                      <div className='icon-row'>
                        <div className='col'>
                          <a style={{textDecoration:'none'}} href="https://twitter.com/AltCoinKid">
                            <img src='images/web/twitter_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                        <div className='col'>
                        <a style={{textDecoration:'none'}} href="https://t.me/jchaps11">
                            <img src='images/web/telegram_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                        <div className='col'>
                        <a style={{textDecoration:'none'}} href="https://discord.gg/GRQrmvZY8y">
                            <img src='images/web/discord_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                      </div>
                      </div>
                  ...
                  <div to='' className='team__container-card'>
                    <div className='team__container-cardInfo'>
                      <div className="team__container-features">
                        ...
                        <div className='icon-row'>
                        <div className='col'>
                          <a style={{textDecoration:'none'}} href="https://twitter.com/onenewman_">
                            <img src='images/web/twitter_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                        <div className='col'>
                        <a style={{textDecoration:'none'}} href="https://t.me/now73">
                            <img src='images/web/telegram_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                        <div className='col'>
                  ...
                  <div to='' className='team__container-card'>
                    <div className='team__container-cardInfo'>
                      ...
                      <div className='icon-row'>
                      <div className='col'>
                          <a style={{textDecoration:'none'}} href="https://twitter.com/stelinho7">
                            <img src='images/web/twitter_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                        <div className='col'>
                        <a style={{textDecoration:'none'}} href="https://t.me/callmeste">
                            <img src='images/web/telegram_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                        <div className='col'>
                ...
                <div to='' className='team__container-card'>
                    <div className='team__container-cardInfo'>
                      ...
                      <div className='icon-row'>
                      <div className='col'>
                          <a style={{textDecoration:'none'}} href="https://twitter.com/satoshiijunior">
                            <img src='images/web/twitter_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                        <div className='col'>
                        <a style={{textDecoration:'none'}} href="https://t.me/Satoshi_Junior">
                            <img src='images/web/telegram_icon.png' alt='' width="25px" className='icon' />
                          </a>
                        </div>
                        <div className='col'>
                  ...
                  <div to='' className='team__container-card'>
                    <div className='team__container-cardInfo'>
                      <div className="team__container-features">
                        ...
                        <div className='icon-row'>
                          <div className='col'>
                          <a style={{textDecoration:'none'}} href="cometaclub@pm.me">
                              <img src='images/web/email_icon.png' alt='' width="25px" className='icon' />
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className='team__container-cardInfo'>
                      ...
                      <div className='col'>
                          <a style={{textDecoration:'none'}} href="">
                              <img src='images/web/at_icon.png' alt='' width="25px" className='icon' />
                            </a>
                          </div>
                          <div className='col'>
                          <a style={{textDecoration:'none'}} href="aggie.pictures@pm.me">
                              <img src='images/web/email_icon.png' alt='' width="25px" className='icon' />
                            </a>
                          </div>
                        </div>
        ...
        <div style={{maxWidth: '1000px', minWidth:'300px'}}>
          ...
          <div className='roadmap'><p style={{fontSize: '15px', textAlign:'start'}}>Co-Meta Worlds, Investor Dashboard and Game-to-Earn</p>
            <p style={{textAlign:'start', paddingRight:'25px'}}>Official release of our DAO estates. Virtual Worlds minted on ERC-721 smart 
            contracts ready to be explored by our Cosmosapiens, both social spaces game-to-earn plots.
            Launch of our Investor's Dashboard NFT platform exchange and private ERC-721 metaverse estates.
            </p>
          </div>
          ...
          <div className='roadmap'>
              <p style={{ fontSize:'14px', textAlign:'start' , textAlign:'justify', paddingRight:'25px'}}> We are adding more avenues to 
              bring long term utility to holders such as 
              future rare collectible airdrops, immersive VR space environments and most excitedly - 
              NFT minted Metaverse ETH-estate PODs, coin staking, deflationary mechanisms and interactive 
              features and animations. 
              We value our community above all else and want all of you to be a big part of moving 
              ...
              $Cometa and Cosmosapiens holders will be considered part of the Cosmosapiens POD and have access to exclusive 
